...
package everlinkintl.com.myappwh.zxing.view;
...
public final class ViewfinderView extends View {
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    labelTextSize = array.getFloat(R.styleable.ViewfinderView_label_text_size, 72f);
  ...
  private void drawTextInfo(Canvas canvas, Rect frame) {
    ...
    canvas.drawText(labelText, frame.left + frame.width() / 2, frame.top/2, paint);
  }
