...
//    private static final int BOTTOM_BTN_HEIGHT = Constant.RECT_VIEW_BOTTOM;
    ...
    private static final String TIPS = "分单号放入框中";
...
//        viewHeight = panelHeght - (int) DisplayUtil.dp2px(activity,TOP_BAR_HEIGHT + BOTTOM_BTN_HEIGHT);
        ...
        shangyi=viewHeight/4;
        /*rectWidth = panelWidth
                - UnitUtils.getInstance(activity).dip2px(
                        LEFT_PADDING + RIGHT_PADDING);*/
        rectWidth = panelWidth - (int) Tools.dp2px(activity,LEFT_PADDING + RIGHT_PADDING);

        rectHeght = (int) (rectWidth * 54 / 150);
        // 相对于此view
        rectTop = (viewHeight - rectHeght) / 2-shangyi;
        ...
        linePaint.setColor(Color.rgb(0, 118, 255));
        ...
        rect = new Rect(rectLeft, rectTop - 120, rectRight, rectTop - 10);
    ...
    public void onDraw(Canvas canvas) {
        ...
        rect = new Rect(0, viewHeight/2+rectHeght/2-shangyi, viewWidth, viewHeight);
        ViseLog.e(rect.left+";"+rect.right+";"+rect.top+";"+rect.bottom);
        canvas.drawRect(rect, wordPaint);

        rect = new Rect(0, 0, viewWidth, viewHeight/2-rectHeght/2-shangyi);
        ViseLog.e(rect.left+";"+rect.right+";"+rect.top+";"+rect.bottom);
        canvas.drawRect(rect, wordPaint);

        rect = new Rect(0, viewHeight/2-rectHeght/2-shangyi, (viewWidth-rectWidth)/2, viewHeight/2+rectHeght/2-shangyi);
        ViseLog.e(rect.left+";"+rect.right+";"+rect.top+";"+rect.bottom);
        canvas.drawRect(rect, wordPaint);

        rect = new Rect(viewWidth-(viewWidth-rectWidth)/2, viewHeight/2-rectHeght/2-shangyi, viewWidth, viewHeight/2+rectHeght/2-shangyi);
        ViseLog.e(rect.left+";"+rect.right+";"+rect.top+";"+rect.bottom);
        canvas.drawRect(rect, wordPaint);
